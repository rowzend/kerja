...
<div class="col-md-6 mb-4">
        <div class="card shadow">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    <label for="file1">Berkas Satu</label>
                    <input type="file" id="file1" name="file1" class="form-control" placeholder="Berkas 1">
                </div>
                <div class="form-group mb-3">
                    <label for="file2">Berkas Dua</label>
                    <input type="file" id="file2" name="file2" class="form-control" placeholder="JBerkas 2">
                </div>
                <button type="submit" class="btn mb-2 btn-primary btn-lg btn-block">Simpan C</button>
                </form>
            </div> <!-- /.card-body -->
        </div> <!-- /.card -->
    </div>
