                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('izin.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row mb-3"><label class="col-sm-2 col-form-label"
                                            for="pangkat">Pangkat-Gol/Ruang</label>
                                        <div class="col-sm-10"><select class="form-control" id="pangkat" name="pangkat"
                                                required>
                                    ...
                                    <div class="row mb-3"><label class="col-sm-2 col-form-label" for="unorb">Unit
                                            Kerja*</label>
                                        <div class="col-sm-10"><input class="form-control" id="unorb" name="unorb"
                                                type="text" placeholder="Organisasi Perangkat Daerah Tujuan">
                                                <span class="help-block"><small>*hanya di isi apabila?1</small></span>
                                        </div>
                                    </div>
                                    <div class="row mb-3"><label class="col-sm-2 col-form-label"
                                            for="jabtu">Jabatan*</label>
                                        <div class="col-sm-10"><input class="form-control" id="jabtu" name="jabtu"
                                                type="text" placeholder="Jabatan yang akan diisi">
