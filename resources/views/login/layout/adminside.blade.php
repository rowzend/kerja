<nav class="vertnav navbar navbar-light">
    ...
    <div class="w-100 mb-4 d-flex">
        <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="/admin/home">
            <img version="1.1" id="logo" class="navbar-brand-img brand-sm" src="{{ asset('base/img/logo/bkd.png') }}">
                </a>
    </div>
    ...
    <li class="nav-item dropdown">
            <a href="#profile" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">User Manager</span>
            </a>
            <ul class="collapse list-unstyled pl-4 w-100" id="profile">
                <a class="nav-link pl-3" href="{{ route('fulluser.index') }}"><span class="ml-1">Overview</span></a>
