...
<body class="vertical  light  ">
  <div class="wrapper">
    @if(auth()->user()->type=='mutasi')
    @include('login.layout.usertop')
    @elseif(auth()->user()->type=='izin')
    @include('login.layout.usertop')
    @elseif(auth()->user()->type=='setuju')
    @include('login.layout.usertop')
    ...
    <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
      ...
      @if(auth()->user()->type=='mutasi')
      @include('login.layout.mutasiside')
      @elseif(auth()->user()->type=='izin')
      @include('login.layout.izinside')
      @elseif(auth()->user()->type=='setuju')
      @include('login.layout.setujuside')
      @elseif(auth()->user()->type=='admin')
